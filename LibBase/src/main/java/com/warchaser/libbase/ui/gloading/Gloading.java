package com.warchaser.libbase.ui.gloading;
...
public class Gloading {
    ...
    public interface Adapter {
         ...
         * @see Holder
         */
        View getView(Holder holder, View convertView, int status, String emptyHint, int type);
    }
    ...
    public static class Holder {
        ...
        public void showLoading(int type) {
            showLoadingStatus(STATUS_LOADING, null, type);
        }
        /** show UI for status: {@link #STATUS_LOAD_SUCCESS} */
        public void showLoadSuccess(int type) {
            showLoadingStatus(STATUS_LOAD_SUCCESS, null, type);
        }
        /** show UI for status: {@link #STATUS_LOAD_FAILED} */
        public void showLoadFailed(int type) {
            showLoadingStatus(STATUS_LOAD_FAILED, null, type);
        }
        /** show UI for status: {@link #STATUS_EMPTY_DATA} */
        public void showEmpty(String emptyHint, int type) {
            showLoadingStatus(STATUS_EMPTY_DATA, emptyHint, type);
        }
         ...
         * @param status status
         * @see #showLoading(int)
         * @see #showLoadFailed(int)
         * @see #showLoadSuccess(int)
         * @see #showEmpty(String, int)
         */
        public void showLoadingStatus(int status, String emptyHint, int type) {
            ...
            try {
                ...
                View view = mAdapter.getView(this, convertView, status, emptyHint, type);
                if (view == null) {
