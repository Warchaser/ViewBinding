...
public class SupportFragment extends Fragment implements ISupportFragment {
    ...
    protected ISupportActivity _mActivity;
    ...
    public void onAttach(Activity activity) {
        ...
        _mActivity = (ISupportActivity) mDelegate.getActivity();
    }
    ...
    public void startDontHideSelf(ISupportFragment fragment){
        extraTransaction()
                .setCustomAnimations(R.anim.anim_current_list_enter, 0, 0, R.anim.anim_current_list_exit)
